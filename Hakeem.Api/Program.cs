...
public class Program
{
    ...
    {
        // Initialize basic console logging for bootstrap
        ...
        try
        {
            ...
            // Add services to the container with enhanced security and monitoring
            builder.Services
            ...
            // Configure file settings (BaseUrl for file paths)
            ...
            .ConfigureApiBehaviorOptions(options => options.InvalidModelStateResponseFactory = context => ValidationResult(context))
                .AddJsonOptions(options =>
                {
                    ...
                    // Security: Limit recursion depth to prevent DoS attacks
                    options.JsonSerializerOptions.MaxDepth = 64;

                    // // Performance: Set reasonable buffer sizes
            ...
            // Validate critical configuration on startup (disabled for EF migrations)
            // await ValidateConfigurationAsync(app.Services);

            // Log application startup information
            LogStartupInformation(app);

            // Configure the comprehensive middleware pipeline
    ...
    /// <summary>
    /// Logs important application startup information
    /// </summary>
    ...
    /// <summary>
    /// Applies database migrations automatically on application startup
    /// </summary>
    private static async Task ApplyDatabaseMigrationsAsync(IServiceProvider services)
    {
        ...
        catch (Exception ex)
        {
            ...
            // In production, you might want to throw here to prevent startup with inconsistent database
            // throw;
        }
    }

    /// <summary>
    /// Applies pending migrations for a specific DbContext
    /// </summary>
