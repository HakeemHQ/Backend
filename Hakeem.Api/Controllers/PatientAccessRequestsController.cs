...
{
    [HttpGet]
    [ProducesResponseType(typeof(GenericResponseModel<PaginatedResult<PatientAccessRequestItem>>), StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> Get(
        [FromQuery] GetPatientAccessRequestsQuery query,
