...
/// <summary>
/// Security configuration extensions for dependency injection
/// </summary>
public static class SecurityExtensions
{
    /// <summary>
    /// Configures comprehensive security services
    /// </summary>
    ...
    /// <summary>
    /// Configures JWT authentication with comprehensive security settings
    /// </summary>
        ...
        Hakeem.Api.Configuration.JwtConfiguration jwtConfig)
    {
        ...
        services.AddAuthorization(options =>
        {
            ...
            options.FallbackPolicy = new Microsoft.AspNetCore.Authorization.AuthorizationPolicyBuilder()
                ...
                .Build();
            // // Phone verification policy - requires phone_verification scope
            // options.AddPolicy("PhoneVerified", policy =>
            //     policy.RequireClaim("scope", "phone_verification"));
        });
        return services;
    }

    /// <summary>
    /// Configures CORS with security-focused settings
    /// </summary>
