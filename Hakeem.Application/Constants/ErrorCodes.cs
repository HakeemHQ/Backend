...
/// These codes are returned in the API response "code" field and
/// correspond to resource keys in SharedResource.resx for localization.
/// Convention: {Domain}.{ErrorType}
/// </summary>
