...
public sealed class GetPatientDoctorAccessesQueryValidator
    : AbstractValidator<GetPatientDoctorAccessesQuery>
{
    public GetPatientDoctorAccessesQueryValidator(
