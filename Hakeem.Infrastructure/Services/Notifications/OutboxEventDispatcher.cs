...
/// <summary>
/// Custom event dispatcher that mimics MediatR's Publish behavior without using MediatR.
/// Resolves <see cref="IOutboxEventHandler{TEvent}"/> from DI and invokes HandleAsync.
/// </summary>
public class OutboxEventDispatcher
{
    ...
    /// <summary>
    /// Deserializes the event payload, resolves the matching handler from DI, and invokes it.
    /// </summary>
