...
/// <summary>
/// Background worker that polls the OutboxEvents table, claims pending events,
/// dispatches them through <see cref="OutboxEventDispatcher"/>, and handles retries.
/// Uses SQL Server row-level locking (UPDLOCK, ROWLOCK, READPAST) to prevent double-processing.
/// </summary>
